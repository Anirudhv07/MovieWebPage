...
// import { latestMovies } from '../../apiConnection/api';
...
//         const latestMoviesResponse=await latestMovies()
//         console.log(latestMoviesResponse,'latesttt');
        
//         setMovies(latestMoviesResponse)
//     }
...
// <div className='py-3'>
//     <Typography color='white' variant='h3'>Latest Movies</Typography>
// </div>
